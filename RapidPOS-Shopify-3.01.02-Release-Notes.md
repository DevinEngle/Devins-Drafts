...
Previously, syncing a customer to Shopify could fail with a generic "Object reference not set to an instance of an object" error if that customer's email address was already in use by another Shopify customer. This has been fixed.
