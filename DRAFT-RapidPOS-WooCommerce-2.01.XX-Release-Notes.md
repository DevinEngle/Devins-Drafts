...
If a product variation was deleted directly in WooCommerce before the sync could remove it, the connector now logs a clear, plain-language message instead of a technical error.
...
- If the variation is already gone, the connector now logs a message such as: `Product variant [SKU] (WooCommerce ID [ID]) was already removed from WooCommerce.`
